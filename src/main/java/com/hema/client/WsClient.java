...
public class WsClient implements Runnable{
	 ...
	 */
	public WsClient(String url,String processId,String tenant) {
		this.url = url;
		this.processId = processId;
		final String base64 = ByteArrUtil.getBase64(tenant);
		this.XAUTHTENANT = base64;
		this.XAUTHUSER = base64;
...
//		this.stompClient.setMessageConverter(new SimpleMessageConverter());
		this.stompSessionHandler = new MyStompSessionHandler(this.processId,this.XAUTHTENANT);
